                ...
                <div class="modal-body bg-white">
                    <div class="row g-3">
                        ...
                        @include('helper.formhelper.form', [
                            'type' => 'text',
                            'fieldname' => 'form.question',
                            'labelname' => 'QUESTION',
                            'labelidname' => 'questionid',
                            'required' => true,
                            'readonly' => false,
                            'col' => 'col-md-12 mb-3',
                        ])
                        ...
                        @include('helper.formhelper.form', [
                            'type' => 'text',
                            'fieldname' => 'form.answer',
                            'labelname' => 'ANSWER',
                            'labelidname' => 'answerid',
                            'required' => true,
                            'readonly' => false,
                            'col' => 'col-md-12 mb-3',
                        ])
                        ...
                        @include('helper.formhelper.form', [
                            'type' => 'select',
                            'fieldname' => 'form.panel',
                            'labelname' => 'PANEL',
                            'labelidname' => 'panelid',
                            'option' => Config::get('archive.panel'),
                            'default_option' => 'Select a Panel',
                            'required' => true,
                            'readonly' => false,
                            'col' => 'col-md-3',
                        ])
